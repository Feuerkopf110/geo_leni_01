...
!(function (e, t) {
        ...
        d.fn.parse = function (o) {
            ...
            return (
                this.each(function (e) {
                    ...
                    for (var t = 0; t < this.files.length; t++) u.push({ file: this.files[t], inputElem: this, instanceConfig: d.extend({}, r) });
                }),
                e(),
                this
            );
            function e() {
                if (0 !== u.length) {
                    ...
                    if (J(o.before)) {
                        ...
                        if ("object" == typeof s) {
                            if ("abort" === s.action) return (e = "AbortError"), (t = n.file), (r = n.inputElem), (i = s.reason), void (J(o.error) && o.error({ name: e }, t, r, i));
    ...
    function h(e) {
        (this._handle = null),
            ...
            (this.parseChunk = function (e, t) {
                ...
                if (!this._handle.paused() && !this._handle.aborted()) {
                    ...
                    return (
                        ...
                        this._completed || !a || !J(this._config.complete) || (n && n.meta.aborted) || (this._config.complete(this._completeResults, this._input), (this._completed = !0)),
            ...
            (this._sendError = function (e) {
                J(this._config.error) ? this._config.error(e) : o && this._config.error && f.postMessage({ workerId: b.WORKER_ID, error: e, finished: !1 });
            });
    }
    function l(e) {
        var i;
            ...
            (this._readChunk = function () {
                if (this._finished) this._chunkLoaded();
                    ...
                    if (
                        ...
                        n || ((i.onload = v(this._chunkLoaded, this)), (i.onerror = v(this._chunkError, this))),
                        i.open(this._config.downloadRequestBody ? "POST" : "GET", this._input, !n),
            ...
            (this._chunkLoaded = function () {
                4 === i.readyState &&
                    (i.status < 200 || 400 <= i.status
                        ? this._chunkError()
                        : ((this._start += this._config.chunkSize ? this._config.chunkSize : i.responseText.length),
                          (this._finished =
    ...
    function c(e) {
        ...
        (this.stream = function (e) {
            (this._input = e),
                ...
                s ? (((i = new FileReader()).onload = v(this._chunkLoaded, this)), (i.onerror = v(this._chunkError, this))) : (i = new FileReaderSync()),
                this._nextChunk();
        }),
    ...
    function r(m) {
        ...
        function g() {
            return (
                c && u && (k("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + b.DefaultDelimiter + "'"), (u = !1)),
                m.skipEmptyLines &&
        ...
        function v(e, t) {
            return (
                (r = e),
                m.dynamicTypingFunction && void 0 === m.dynamicTyping[r] && (m.dynamicTyping[r] = m.dynamicTypingFunction(r)),
        ...
        (this.parse = function (e, t, r) {
            ...
            if (
                ...
                J(m.delimiter) && ((m.delimiter = m.delimiter(e)), (c.meta.delimiter = m.delimiter));
            else {
    ...
    function E(j) {
        ...
        (this.parse = function (i, t, r) {
            ...
            function L(e) {
                return { data: u, errors: h, meta: { delimiter: M, linebreak: P, aborted: H, truncated: !!e, cursor: d + (t || 0) } };
            }
            function F() {
                q(L()), (u = []), (h = []);
            }
    ...
    function _(e) {
        ...
        if (t.error) r.userError(t.error, t.file);
            ...
            var n = {
                abort: function () {
                    (i = !0), m(t.workerId, { data: [], errors: [], meta: { aborted: !0 } });
                },
                pause: y,
                resume: y,
            };
